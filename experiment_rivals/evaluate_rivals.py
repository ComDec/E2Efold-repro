...
print('\n' + '=' * 60)
print('Evaluating on val (TestSetA)...')
mA_deep, mA_e2e = evaluate_dataset('TestSetA (val)', '../data/{}/'.format(data_type), 'val')

print('\n' + '=' * 60)
print('Evaluating on test (TestSetB)...')
mB_deep, mB_e2e = evaluate_dataset('TestSetB (test)', '../data/{}/'.format(data_type), 'test')
