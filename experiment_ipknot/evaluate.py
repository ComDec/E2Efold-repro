"""
Evaluate Stage 1 score network on iPKnot with non-learned post-processing.
...
# iPKnot: val and test are the same file (bpRNA-PK-TS0-1K.pkl)
# We evaluate on "test" only (no separate val)
print('\n' + '=' * 60)
print('Evaluating on test (saving predictions)...')
print('NOTE: For iPKnot, val and test are the same dataset (bpRNA-PK-TS0-1K.pkl)')
mT_deep, mT_e2e, test_preds = evaluate_dataset('test (bpRNA-PK-TS0-1K)', '../data/{}/'.format(data_type), 'test',
